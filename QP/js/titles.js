...
title[2] = new Object();
title[2].name = "TRADER";
title[2].description = "You are skilled in the art of negotiation";
title[2].effect = "All Hunts cost 50% less";
title[2].unlock = "Not Available"//"Reach Friendship Level 20 with all Wardens";

title[3] = new Object();
title[3].name = "TRACKER";
title[3].description = "You know the grasslands like the back of your hand";
title[3].effect = "Increased # of rewards when hunting in the Grasslands";
title[3].unlock = "Not Available"//"Reach Friendship Level 20 with Neeka";

title[4] = new Object();
title[4].name = "EXPLORER";
title[4].description = "You know the caverns like the back of your hand";
title[4].effect = "Increased # of rewards when hunting in Caves";
title[4].unlock = "Not Available"//"Reach Friendship Level 20 with Roz";

title[5] = new Object();
title[5].name = "HIKER";
title[5].description = "You know the mountains like the back of your hand";
title[5].effect = "Increased # of rewards when hunting in the Mountains";
title[5].unlock = "Not Available"//"Reach Friendship Level 20 with Rayla";

title[6] = new Object();
title[6].name = "SLAYER";
title[6].description = "You are skilled with a blade";
title[6].effect = "All SLASH damage is increased by 100%";
title[6].unlock = "Not Available"//"Use a SLASH type ULTIMATE over 25 times";

title[7] = new Object();
title[7].name = "BRUISER";
title[7].description = "You are skilled with a hammer";
title[7].effect = "All BASH damage is increased by 100%";
title[7].unlock = "Not Available"//"Use a BASH type ULTIMATE over 25 times";

title[8] = new Object();
title[8].name = "ROGUE";
title[8].description = "You are skilled with a knife";
title[8].effect = "All STAB damage is increased by 100%";
title[8].unlock = "Not Available"//"Use a STAB type ULTIMATE over 25 times"; 
