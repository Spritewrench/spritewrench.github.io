(function() {
  ...
  Rank.prototype = {
    ...
    create: function () {
      ...
      this.guildItem = this.add.sprite(this.game.width/2, this.game.height/2-300, guildItem[this.weekOfMonth].name);
      this.guildItem.anchor.setTo(0.5, 0.5);
      this.guildItem.width =  250;
      this.guildItem.height = 250;
      
      this.guildItemText = this.add.text(this.guildItem.x,this.guildItem.y-300, "This Week\nThe Hunter's Guild\nis Looking For: ",{font:'LondrinaSolid-Black'});
      this.guildItemText.fill= '#fff';  
      this.guildItemText.fontSize = 70;  
      ...
      this.guildItemText2 = this.add.text(this.guildItem.x,this.guildItem.y+300, guildItem[this.weekOfMonth].name+"\n for\n"+guildItem[this.weekOfMonth].exp+" EXP points EACH",{font:'LondrinaSolid-Black'});
      this.guildItemText2.fill= '#fff';  
      this.guildItemText2.fontSize = 50;  
      ...
      this.guildItemText3 = this.add.text(this.guildItem.x,this.guildItem.y+150,"test/test" ,{font:'LondrinaSolid-Black'});
      this.guildItemText3.fill= '#fff';  
      this.guildItemText3.fontSize = 36;  
      ...
      this.expText= this.add.text(this.guildItem.x+100,this.guildItem.y+500, this.hunterExp+"/"+this.nextRankExp+"\n To Next Rank",{font:'LondrinaSolid-Black'});
      this.expText.fill= '#fff';  
      this.expText.fontSize = 36;  
      ...
      this.rankBadge = this.add.sprite(this.guildItem.x-150, this.guildItem.y+500, "rankBadge");  
      this.rankBadge.width =  200;
      this.rankBadge.height = 200;  
      this.rankBadge.anchor.setTo(0.5, 0.5);
      this.rankText= this.add.text(this.guildItem.x-150,this.guildItem.y+500, this.currentRank,{font:'LondrinaSolid-Black'});
      this.rankText.fill= '#fff';  
      this.rankText.fontSize = 70;  
      ...
      this.submitButton = this.add.sprite(this.game.width/2-260, this.game.height-500, "submit");  
      this.submitButton.width =  500;
      this.submitButton.height = 240;      
      this.submitButton.inputEnabled = true;
      this.submitButton.events.onInputDown.add(this.submit, this);  
      

      this.returnButton = this.add.sprite(this.game.width/2-200, this.game.height-250, "return_"+this.biome+"MINI");  
    ...
    update: function () {
      this.expText.text = (this.hunterExp)+"/"+(this.nextRankExp)+"\n To Next Rank"
      this.rankText.text = this.currentRank;
          ...
          this.guildItemText3.text = inveNum+"/"+guildItem[this.weekOfMonth].qty      
