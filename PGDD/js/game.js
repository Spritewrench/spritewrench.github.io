    ...
    Game.prototype = {
        create: function () {
            ...
            switch(this.level){
              ...
              case 51:
                text = "0000000002111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111";
              break;     
              case 52:
                text = "0000000001011111110100000000010011111111001111111100111111110211111111010011111100000011111110011111";
              break;       
              case 53:
                text = "0000211111000001111100110111110011011111000101111111010111111101011111110001111111111111111111111111";
              break;     
              case 54:
                text = "0021111111001111111110000000011121001101110100110111010011011101001101110100000111000111111111111111";
              break;     
              case 55:
                text = "0000200002000000000011111111111111111111111111111111111111111111111111111111111111111111111111111111";
              break;     
              case 56:
                text = "0002111111011011111101101111110110111111011011111101101111112002111111111111111111111111111111111111";
              break;  
              case 57:
                text = "0000000211000000001111111100111111110011000000001100000000111111111111111111111111111111111111111111";
              break;     
              case 58:
                text = "0000000000211111111000000000000010001000000010101001111010100111100010000000000000000000000000000000";
              break;     
              case 59:
                text = "0211001000002100100000010010000001001000000100100000010010000000001000001110100000111000000011111100";
              break;     
              case 60:
                text = "0010011111001001111100000111110000211111100000000010000000001010001000101010101010101010101000100010";
              break;      
              case 61:
                text = "0000000001010000000101001110010100111001002111100111000002111100000011111111111111111111111111111111";
              break;     
              case 62:
                text = "0000000000011111112000000000001111111110000000000020000000001111111111111111111111111111111111111111";
              break;       
              case 63:
                text = "0100010001010101010101010101010101010101010101010100010001011000000001120000001111111111111111111111";
              break;     
              case 64:
                text = "0011111111101111111112011111111101111111112011111111101111111112011111111101111111112000001111100002";
              break;     
              case 65:
                text = "0010000211001001001100100100110010010011001001001100100100110010010011001001001100100100111000110011";
              break;     
              case 66:
                text = "0000000000211111111000000000000010001000001010101000101010100010101010001010001000001111100000000000";
              break;  
              case 67:
                text = "0000000000200110001000011010000001101111000110111101020011110101111111010111111100011111111111111111";
              break;     
              case 68:
                text = "0021111111100111111100111111110111111111002111111110011111110011111111011111111100211111111001111111";
              break;     
              case 69:
                text = "0002002002100000000010100100101010010010101001001010100100101010010010101001001010000000001111111111";
              break;     
              case 70:
                text = "0000000000000000000001100001100110000110010000010001000001000110000110011000011000000000001111221111";
              break;      
              
              case 71:
                text = "0001111111110111111100000000000100000010010100101001010010100101001010010100101000210012001111111111";
              break;         
              case 72:
                text = "0011111111002001111100010100020001010000000101000002010100000001010000000001000000000000001111111111";
              break;    
              case 73:
                text = "0000000001001111110100111111010011111101001111110120000000010011111111111111111111111111111111111111";
              break;    
              case 74:
                text = "0000000000000000000000000000000011111111000000001101111110110100000011010111111101000001112000000111";
              break;    
              case 75:
                text = "0100011111000001111110001111111000011111100201111110000001111001110111100000011110000021111111111111";
              break;    
              case 76:
                text = "0000111111011000001100000000110000000002000000000000000000110110000011000011111111111111111111111111";
              break;    
              case 77:
                text = "0000111111011000001100000000110200000002000000000000000000110110000011000011111111111111111111111111";
              break;    
              case 78:
                text = "0222222222111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111";
              break;    
              case 79:
                text = "0000000000211100111200000000000110000110011000011000000000000011001100000000000000000000000000000000";
              break;    
              case 80:
                text = "0000111111100000000010000100000000010000000001000000200100000000010000000001000000000111100000000000";
              break;      
              case 81:
                text = "0000001111200000111110000111111111111111111111111111111111111111111111111111111111111111111111111111";
              break;         
              case 82:
                text = "0000011111011100000001111111100111000000020001111101111111110200011111011100000001111111100000000000";
              break;    
              case 83:
                text = "0011111001001111100100111100010011110101000110010101011011010100001101011001110100022000011111111111";
              break;    
              case 84:
                text = "0000011111011101111100000111110020011111000001111101110111110000011111111111111111111111111111111111";
              break;    
              case 85:
                text = "0000000000000002000011101101111110020111111011011111100201111110110111111011011111100001111111111111";
              break;    
              case 86:
                text = "0000000000000000000000111111001020000000101111111010000000001111111100000000000001111111100000000000";
              break;    
              case 87:
                text = "0001111111000111111100011111110000211111000001111100011111110000011111000001111100011111110001111111";
              break;    
              case 88:
                text = "0000000000000000000010000000001000000011100000001110000000111000000011100000111110022111111221111111";
              break;    
              case 89:
                text = "0000000002011111111020000000100111111010010000101001011210100101111010010000001001111111102000000002";
              break;    
              case 90:
                text = "0000111111000011111110001111111000111111100011111110001111111000111111100211111110211111111111111111";
              break;                                                                                                                                                   
