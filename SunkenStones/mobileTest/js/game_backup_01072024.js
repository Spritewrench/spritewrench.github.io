(function () {
  ...
  this.selectInfoDetail.filters = [ this.filter ];   
            ...
            this.exit_Button_outline = this.add.sprite(75, 75, 'ui_clear_button_outline');            
            ...
            this.exit_Button = this.add.sprite(75, 75, 'crewRemove');            
            ...
            this.clear_Button_outline = this.add.sprite(this.game.width/2+500, this.game.height-200, 'ui_clear_button_outline');            
            ...
            this.clear_Button = this.add.sprite(this.game.width/2+500, this.game.height-150+35, 'ui_clear_button');            
          ...
          for(var i = 1 ; i < 10; i++){
            ...
            this.collectedTreasure[i].alpha = 0//0.3;
          ...
          if(parseInt(localStorage.getItem("intro")) == 1 || onboardingDebug){
            this.freeCounter[i].num = 0 
          } 
          else{
            this.freeCounter[i].num  = startingBombCount
          } 
          }
          ...
          this.chestMeterBar = this.add.sprite(30, 20, 'saltMeter');
          ...
          this.chestUI = this.add.sprite(this.chestMeter.x, this.chestMeter.y-this.chestMeter.height/2+50, 'gatheredChests');
          this.chestUI.anchor.setTo(0.5, 0.5); 
          this.chestUI.width = 100
          this.chestUI.height = 100                         

          this.monCombo = 0;
          this.monComboText = this.add.text(this.game.width-300,this.game.height/2, 'COMBO', {font: '64px Kaph-Regular',fill: '#fff', align: 'center'});
          this.monComboText.anchor.setTo(0.5, 0.5);     
          this.monComboText.angle = 10 
          this.monComboText.origHeight = this.monComboText.height  
          this.monComboText.origY = this.monComboText.y       
          ...
          this.saltMeter.alpha = 0
          //this.chestUI.alpha = 0;
          this.saltMeterUI.alpha = 0;
          this.saltMeterBack.alpha = 0;
          ...
          this.reRoll_Button_outline = this.add.sprite(this.game.width/2+500, this.game.height-200, 'ui_clear_button_outline');            
          ...
          this.reRoll_Button = this.add.sprite(this.game.width/2+500, this.game.height+200, 'ui_reroll_button');            
          ...
          for(var i =0; i < 3; i++){
            ...
            this.crewOptions[i].name = this.add.text(this.crewOptions[i].x,this.crewOptions[i].y-200, ' ',{font: '32px LondrinaSolid-Black',fill: '#fff', align: 'center', wordWrap: true, wordWrapWidth: 200  });
        ...
        , update: function () {
          ...
          if(this.monCombo > 0 ){
            this.monComboText.text = "COMBO +"+this.monCombo
            this.monComboText.y +=  (this.monComboText.origY -this.monComboText.y) * 0.1;
          }
          else if(this.monCombo == -1){
            //this.monComboText.text = "COMBO +"+this.monCombo
            this.monComboText.y +=  (this.monComboText.origY -this.monComboText.y) * 0.1;
          }          
          else{
            this.monComboText.y +=  (this.game.height+1000 -this.monComboText.y) * 0.1;
          }

          this.monComboText.height +=  (this.monComboText.origHeight -this.monComboText.height) * 0.1;
            ...
            if(this.chatTimer == 0){
              ...
              for(var i = 1; i < 10; i++){
                if(this.collectedTreasure[i].count > 0){
                  this.collectedTreasure[i].alpha = 0//1
                  this.collectedTreasureText[i].alpha = 0//1
              ...
              //cap info panel
              this.capInfo.x += 0//(0 - this.capInfo.x) * 0.2;
              ...
              if(this.clearbuttonTimer > 0 ){
                ...
                this.clear_Button.y = this.game.height-200+35
              }
              else{
                this.clear_Button.y = this.game.height-200
              }
              ...
              */
                ...
                if(this.crew[i].speechTimer > 0){
                  ...
                  if(this.crew[i].speechTimer == 0){
                    ...
                    if(i == 4 && parseInt(localStorage.getItem("intro")) == 11){
                      ...
                      this.freeCounter[5].counter2.text = "+5💣"                          
                    }
                    /*
                    for(var k = 1; k < this.crew.length; k++){
              ...
              for(var i = 0; i < this.boardHeight; i++){
                for(var j = 0; j < this.boardWidth; j++){
                    if(this.tile[''+(j)+(i)].willDie.alpha <= 0 && this.tile[''+(j)+(i)].isEnemyHere && !this.tile[''+(j)+(i)].submerged){
                      incomingTotal += parseInt(this.tile[''+(j)+(i)].power)
                    }     
                }
              }
              if(this.deployReady){
                if(incomingTotal>0){
                  this.incomingDamage.text = "(- "+incomingTotal+")"
                  ...
                  if(incomingTotal>= this.cap_healthValue){
                    this.cap_healthText.text = "☠️"
                  }
                  else{
              ...
              for(var i = 0; i < this.boardHeight; i++){
                  for(var j = 0; j < this.boardWidth; j++){
                    ...
                    */
                    ...
                    //buffs float up
                    if(this.tile[''+j+i].buff.alpha > 0){
                      this.tile[''+j+i].buff.alpha-= 0.01
                      this.tile[''+j+i].buff.y--;
              ...
              if(this.tutorialPause){
                ...
                for(var i =0; i < 3; i++){
                  ...
                  if(this.getTileDetails){
                    ...
                    this.crewOptions[1].powerText.x = this.crewOptions[1].x+(this.crewOptions[1].width/2)-31
                    ...
                    if(this.getCapDetails){
                      this.crewOptions[1].deployText.y =this.crewOptions[1].y+(this.crewOptions[1].height/2)-100
                      this.crewOptions[1].deployText.x = this.crewOptions[1].x-(this.crewOptions[1].width/2)+95
                      this.crewOptions[1].ability.y = this.crewOptions[1].y+210
                      this.crewOptions[1].x =this.treasureOptions[1].x -10
                    }
          ...
          if(!this.getTileDetails){
            if(treasure.alpha == 1 || this.addToCrew || this.removeFromCrew){
              if(this.removeFromCrew){
                ...
                else if(dupe > -1 && upgradeAvailable){
                  /*
        ...
        ,captainUlt: function (tile, pointer){
          ...
          if(pointer.rightButton.isDown && this.chatTimer == 0){

            this.getTileDetails = true;
            this.getCapDetails = true;
            this.chatTimer = 1;

            this.crewOptions[1].loadTexture(this.capBadge.texture)
            ...
            this.popupTail.y = pointer.y-100


            this.treasureOptions[1].y = pointer.y-this.treasureOptions[1].height/2-50
            ...
            if(this.ultKey<=0 && this.deploy_poolCurrent >= this.cap_ultCost && this.phaseCounter == 1 && !this.captainPowerActivated && (this.capKey != 2 || (this.capKey == 2 && this.freeCounter[5].num > 0))){
        ...
        ,spawnMonsters: function (submerged, tile, monID) {
              ...
              for(var j = ranStartX; j < this.boardWidth; j++){      
                ...
                if(placeMonHere == 0 && this.monCount > 0 && !this.tile[''+j+i].isEnemyHere && !this.tile[''+j+i].isCrewHere && (this.monCountValue-this.monKillCount) > 0){
                  ...
                  var healthSpawn = Math.floor(Math.random() * 4)
                   // this.saltCounter >= this.saltCounterMax
                   //spawn chest
                  if(this.turnCountNum == 0 || this.chestMeterBar.height >= 490){
          ...
          if(tile === undefined && monID != 103 ){
            ...
            if(this.monCombo == -1){
              this.chestMeterBar.target = this.chestMeterBar.height
            }
            else{
              this.chestMeterBar.target = this.chestMeterBar.height + (this.monCombo*meterMult)
            }
            
            
            if(this.chestMeterBar.target > 500){
              this.chestMeterBar.target = 500
            }
        ...
        ,crewAttackTile: function (enemy,attkCrew) {   
          try{
           ...
           // if(enemy.isEnemyHere && ((!enemy.submerged) || (enemy.submerged && crewID == 6))){
            ...
            if(enemy.isEnemyHere && ((enemy.submerged)) && attkCrew.crewID == 81){
        ...
        ,placeCrew: function (tile, pointer) {
          ...
          if(pointer.rightButton.isDown){
            ...
            if(tile.isEnemyHere){
              ...
              if(pointer.y <= this.treasureOptions[1].height/2){
                this.treasureOptions[1].y = this.treasureOptions[1].height/2
              }
              if(pointer.x <= this.game.width/2){
                this.treasureOptions[1].x = pointer.x-this.treasureOptions[1].width/2-50
        ...
        ,crewSelected: function (chosen, pointer) {
          ...
          if(pointer.rightButton.isDown && this.cursorSelect.alpha <= 0){
            this.getTileDetails = true;
            this.chatTimer = 1;
            
            
            this.crewOptions[1].loadTexture(chosen.texture)
            ...
            if(pointer.x <= this.treasureOptions[1].width/2){
              this.treasureOptions[1].x = this.treasureOptions[1].width/2+25
            }   
            
            if(pointer.x >= this.game.width - this.treasureOptions[1].width){
        ...
        ,highLightAffect: function (item){
          ...
          if(this.addToCrew ){
            ...
            for(var i = 1; i < this.crew.length; i++){
              this.crewSelect[i].alpha = 0;    
              if(this.crewOptions[item.id].value == this.crew[i].id && upgradeAvailable){
                this.crewSelect[i].alpha = 1;    
              }
            }
        ...
        , showOutline3: function () {
          if(this.chatTimer == 0 && this.ultKey <= 0){
