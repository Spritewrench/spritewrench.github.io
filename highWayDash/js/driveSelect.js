(function() {
  ...
  driveSelect.prototype = {
    ...
    create: function () {
      ...
      this.titleTxt = this.add.bitmapText(x, y-300, 'minecraftia', 'CAR 1', 48); 
      this.titleTxt.anchor.setTo(0.5, 0.5);

      this.rightArrow = this.add.bitmapText(this.game.width-25, y-100, 'minecraftia', '>', 48); 
      this.rightArrow.anchor.setTo(0.5, 0.5);
      this.rightArrow.inputEnabled = true;
      this.rightArrow.events.onInputDown.add(this.next, this);       
      
      this.leftArrow = this.add.bitmapText(25, y-100, 'minecraftia', '<', 48); 
