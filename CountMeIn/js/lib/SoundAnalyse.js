...
Phaser.Plugin.SoundAnalyse = function (game) {
	...
	*/
	Phaser.BitmapDataSoundAnalyze = function (game, key, width, height, soundAnalyser) {
		...
		*/
		this.frequencyDomainChartUniformColor = "#FFF";
	...
	*
	* @method Phaser.SoundAnalyseSprite#setVolume
	*/
	Phaser.SoundAnalyseSprite.prototype.setVolume = function (val) {
		this.songAnalyse.volume = val;
	};	
...
Phaser.Plugin.SoundAnalyse.prototype.add = {
	...
	* @param {Phaser.group} group - group object to add this sprite
	*/
	soundAnalyseSprite: function (game, x, y, width, height, songKey, autoPlay, onDecodeComplete, context, group) {
