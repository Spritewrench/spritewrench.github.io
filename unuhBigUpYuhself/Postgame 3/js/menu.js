(function() {
  ...
  Menu.prototype = {
    ...
    create: function () {
        if (localStorage.getItem("module2Complete") === null ) {
            localStorage.setItem("module2Complete",0);
      ...
      this.moduleCount = 1;
      this.moduleText = this.add.text(this.game.width/2,this.game.height/2,"POSTGAME 3" ,{font:'LondrinaSolid-Black'});
      ...
      if(parseInt(localStorage.getItem("moduleComplete_2B")) == 1){
    ...
    update: function () {
      ...
      switch(this.moduleCount){        
        case 1:
          this.lock.alpha = 0;
          this.moduleText.text = "POSTGAME 3"
    ...
    onDown4: function () {
      ...
      if(this.intro.alpha == 1){
        ...
        try{
          if (messageHandler && parseInt(localStorage.getItem("moduleComplete_2B")) == 1) {
            //tokens no longer additive
            var tokenHolder = parseInt( localStorage.getItem("tokenCount"))
            localStorage.setItem("tokenCount",0);      
            localStorage.removeItem("moduleComplete_2B")                  
            messageHandler.postMessage(
            JSON.stringify({
              tokenValue: tokenHolder,
              gameEnd: true,
            })
            );				
          } 
