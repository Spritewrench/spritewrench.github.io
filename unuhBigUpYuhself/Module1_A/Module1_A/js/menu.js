(function() {
  ...
  Menu.prototype = {
    ...
    create: function () {
      ...
      if(parseInt(localStorage.getItem("moduleComplete_1A")) == 1){
    ...
    onDown4: function () {
      ...
      if(this.intro.alpha == 1){
        ...
        try{
          if (messageHandler && parseInt(localStorage.getItem("moduleComplete_1A")) == 1) {
            //tokens no longer additive
            var tokenHolder = parseInt( localStorage.getItem("tokenCount"))
            localStorage.setItem("tokenCount",0);      
            localStorage.removeItem("moduleComplete_1A")            
