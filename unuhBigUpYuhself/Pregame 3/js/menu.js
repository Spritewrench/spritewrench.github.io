(function() {
  ...
  Menu.prototype = {
    ...
    create: function () {
      ...
      this.moduleCount = 1;
      this.moduleText = this.add.text(this.game.width/2,this.game.height/2,"PREGAME 3" ,{font:'LondrinaSolid-Black'});
    ...
    update: function () {
      ...
      switch(this.moduleCount){        
        case 1:
          this.lock.alpha = 0;
          this.moduleText.text = "PREGAME 3"
    ...
    onDown4: function () {
      ...
      if(this.intro.alpha == 1){
        ...
        try{
          if (messageHandler && parseInt(localStorage.getItem("moduleComplete_2A")) == 1) {
            //tokens no longer additive
            var tokenHolder = parseInt( localStorage.getItem("tokenCount"))
            localStorage.setItem("tokenCount",0);      
            localStorage.removeItem("moduleComplete_2A")                  
