...
var Phasetips = function(localGame, options) {
    ...
    this.updateContent = function(content) {
        ...
        tipBG.width = tipContent.width + _padding;
        tipBG.height =tipContent.height + _padding;        
    ...
    this.createTooltips = function() {
        ...
        var _bgColor = _options.backgroundColor || 0x471929;
        var _strokeColor = _options.strokeColor || 0x914C58;//0xffffff;
        var _strokeWeight = _options.strokeWeight || 5;
        ...
        var _fontSize = _options.fontSize || 14;
        var _fontFill = _options.fontFill || "#ffffff";
        var _fontStroke = _options.fontStroke || "#1e1e1e";
        var _fontStrokeThickness = _options.fontStrokeThickness || 0;
        var _fontWordWrap = _options.fontWordWrap || true;
        var _fontWordWrapWidth = _options.fontWordWrapWidth || 500;
        ...
        var _content = _options.context || ""; // string, bitmapText, text, sprite, image, group
        ...
        if (type === "string" || type === "number") {
            ...
            tooltipContent.y = _padding / 2+20;
    ...
    return {
        ...
        updatePosition: function(x, y) {
            _this.mainGroup.x = x-_this.mainGroup.width/2;
            _this.mainGroup.y = y;
        },
        destroy: function() {
